...
def parse_args():
    ...
    parser.add_argument('--audio', type=str, default="input/output.wav", help="path to the input speech recording")
    parser.add_argument('--text', type=str, default="input/chat_output_en.txt",
